...
import (
	...
	"github.com/elastic/beats/packetbeat/protos/giop"
	"github.com/elastic/beats/packetbeat/protos/mq"
	"github.com/elastic/beats/packetbeat/protos/ctg"
	"github.com/elastic/beats/packetbeat/protos/cbod"
	"github.com/elastic/beats/packetbeat/protos/esb"
	"github.com/elastic/beats/packetbeat/protos/encrypt"
	"github.com/elastic/beats/packetbeat/protos/taicang"
	"github.com/elastic/beats/packetbeat/protos/afa"
	"github.com/elastic/beats/packetbeat/protos/afa2"
)
...
var EnabledProtocolPlugins map[protos.Protocol]protos.ProtocolPlugin = map[protos.Protocol]protos.ProtocolPlugin{
	...
	protos.GiopProtocol:     new(giop.Giop),
	protos.MqProtocol:     new(mq.Mq),
	protos.CtgProtocol:     new(ctg.Ctg),
	protos.CbodProtocol:     new(cbod.Cbod),
	protos.EsbProtocol:     new(esb.Esb),
	protos.EncryptProtocol:     new(encrypt.Encrypt),
	protos.TaicangProtocol:     new(taicang.Taicang),
	protos.AfaProtocol:     new(afa.Afa),
	protos.Afa2Protocol:     new(afa2.Afa2),
}
